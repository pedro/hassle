...
By default, SASS compiles CSS into the @public/@ directory. On platforms like Heroku, this just won't do. Instead, hassle compiles the SASS for you into @tmp/@ and serves it up via a @Rack::Static@ middleware.
